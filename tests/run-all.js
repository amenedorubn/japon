...
const suites = ['test-7a-import.js', 'test-7b-dani.js', 'test-10a-catalog.js', 'test-10b-consolidation.js', 'test-10c-sw.js', 'test-8a-map.js', 'test-8b-platform.js', 'test-12-provenance.js', 'test-12-cord.js', 'test-12-budget.js', 'test-12-confirmed.js', 'test-12-axis.js', 'test-12-seasons.js'];
let failed = 0;
